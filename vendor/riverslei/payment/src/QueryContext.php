...
use Payment\Query\Ali\AliChargeClose;
...
use Payment\Query\Wx\WxChargeClose;
        ...
        try {
            switch ($channel) {
                ...
                case Config::ALI_CLOSE:
                    $this->query = new AliChargeClose($config);
                    break;
                ...
                case Config::WX_TRANSFER:// 微信转款订单查询
                    ...
                    break;
                case Config::WX_CLOSE:// 微信转款订单查询
                    $this->query = new WxChargeClose($config);
                    break;
