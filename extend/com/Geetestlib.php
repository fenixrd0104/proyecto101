...
class Geetestlib {
    ...
    /**
     * Determine whether the test server is down
     *
     * @param null $user_id
     * @return int
     */
    ...
    /**
     * Returns an array for easy expansion
     *
     * @return mixed
     */
    ...
    /**
     * Get the verification result in normal mode
     *
     * @param      $challenge
     * @param      $validate
     * @param      $seccode
    ...
    /**
     * Get the verification result in downtime mode
     *
     * @param $challenge
     * @param $validate
     * @param $seccode
    ...
    private function get_failback_pic_ans($full_bg_index, $img_grp_index) {
        ...
        $answer_decode = "";
        // Generate answer bits by concatenating odd and even bits of two strings
        for ($i = 0; $i < 9; $i++) {
            if ($i % 2 == 0) {
    ...
    /**
     * The input two-digit random number, decode the offset
     *
     * @param $challenge
     * @return mixed
     */
