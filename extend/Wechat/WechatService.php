...
/**
* Official account third-party platform SDK
 *
 * @version 1.0
...
class WechatService {
    ...
    // Get (refresh) the token of the authorized official account
    const REFRESH_ACCESS_TOKEN = '/api_authorizer_token';
    // Get the pre-authorization code
    const PREAUTH_CODE_URL = '/api_create_preauthcode';
    // Get the authorization information of the official account
    const QUERY_AUTH_URL = '/api_query_auth';
    // Get the account information of the authorizer
    const GET_AUTHORIZER_INFO_URL = '/api_get_authorizer_info';
    // Get the option setting information of the authorizer
    const GET_AUTHORIZER_OPTION_URL = '/api_get_authorizer_option';
    // Set the option information of the authorizer
    const SET_AUTHORIZER_OPTION_URL = '/api_set_authorizer_option';

    // The ticket pushed by WeChat in the background is updated every ten minutes
    public $errCode;
   // service appid
       public $errMsg;
       // service appsecret
       protected $component_verify_ticket;
       // Official account message verification Token
       protected $component_appid;
       // Public account message encryption and decryption Key
    ...
    /**
     * Receive Tickets pushed by the public platform
     * @return bool|array
     */
    public function getComonentTicket() {
        ...
        # Session content decryption status judgment
    ...
    /**
     * Get (refresh) the token of the authorized official account
     * @Note 1. Authorized official account to access access token is valid for 2 hours
     * @Note 2. Be sure to save the new refresh token
     * @param string $authorizer_appid Authorizer APPID
     * @param string $authorizer_refresh_token Authorizer refresh token
     * @return bool|string
     */
    ...
    /**
     * Obtain the authorization information of the official account
     *
    ...
    /**
     * Parse the authorization information and return comma-separated data
    ...
    /**
     * Get the authorization fallback address
    ...
    /**
     * oauth Authorized jump interface
     * @param string $appid
     * @param string $redirect_uri
     ...
     * Note: The unionid field will only appear after the user binds the official account to the third-party platform account of the official account. It is recommended to check with isset() before calling
     */
