...
class Gif
{
    ...
    /**
     * List of waiting time per frame
     *
     * @var array
     */
    private $delays = [];
    ...
    /**
     * Constructor for decoding GIF images
     *
     * @param string $src GIF image data
    ...
    /**
     * Set or get the data of the current frame
     *
     * @param string $stream binary data stream
     * @return mixed the obtained data
     */
    ...
    /**
     * move the current frame to the next frame
     *
    ...
    /**
     * Encode and save the current GIF image
     *
     * @param string $gifname image name
     */
