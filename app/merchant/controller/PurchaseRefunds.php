...
use app\merchant\model\PurchaseRefundsListsModel;
use app\merchant\model\PurchaseRefundsLogModel;
use app\merchant\model\PurchaseRefundsModel;
...
class PurchaseRefunds extends Base
{
    ...
    //Create order based on supplier
