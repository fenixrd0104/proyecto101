...
use app\merchant\model\StockPriceListsModel;
use app\merchant\model\StockPriceModel;
use think\Exception;
use think\facade\Db;
...
class StockPrice extends Base
{
   ...
   // create a new inventory
    public function crate(){
       ...
       $id = $StockInventoryModel->createInventory($shop_id,$this->nickname,$this->mid);
       if(!$id){
