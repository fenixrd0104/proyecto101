...
class PopularizeModel extends Model
{
    protected $name = 'popularize';
    ...
    public function insertArticle($param)
    {
        try{
            ...
            if(false === $result){             
                ...
                return ['code' => 1, 'data' => '', 'msg' => 'Promotion added successfully'];
            }
    ...
    public function updateArticle($param)
    {
        try{
            ...
            if(false === $result){
                ...
                return ['code' => 1, 'data' => '', 'msg' => 'Successful promotion and editing'];
            }
        }catch( PDOException $e){
