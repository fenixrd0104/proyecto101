/*
  html5图片压缩 上传 预览
*/
function imgFileupload(imgNum,el,dataUrl) {
...
//    瓦片canvas
    ...
    $(".img-list").on('click', '.close', function(event) {
        ...
        if($this.parents("li").length<imgNum){
            $('.upload').show();
        }
    });
...
//          获取图片大小
            ...
            reader.onload = function() {
                ...
                $(li).append('<div class="img"><img src="'+result+'" alt="" width="100%"></div>');
    ...
    function upload(basestr, type, $li, url) {
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                console.log(text + '：' + jsonData.info);
