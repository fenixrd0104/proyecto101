...
!function(a) {
    ...
    b.prototype.destroy = function() {
        ...
        this.isLink ? this.$element.removeData("fa.editable") : (this.$element.replaceWith(this.getHTML()),
        this.$box && !this.editableDisabled && (this.$box.removeClass("froala-box"),
    ...
    b.prototype.triggerEvent = function(b, c, d, e) {
        ...
        d === !0 && (this.sync(),
        this.isResizing() || this.editableDisabled || this.imageMode || !e || this.cleanify()),
        void 0 === f ? !0 : f
    }
    ,
    ...
    b.prototype.syncClean = function(b, c) {
        ...
        for (var e = !1, f = function(b, c) {
            0 === c.attributes.length && (a(c).remove(),
            e = !1)
    ...
    b.prototype.sync = function() {
        if (!this.isHTML) {
            ...
            this.refreshButtons(),
            this.trackHTML = a) : null == this.trackHTML && (this.trackHTML = a)),
    ...
    b.prototype.init = function(b) {
        ...
        this.$element.bind("mousedown", a.proxy(function(a) {
            a.stopPropagation(),
    ...
    b.prototype.initElement = function(b) {
        ...
        this.editableDisabled || (this.$box = this.$element,
        this.$element = a("<div>"),
        this.setHTML(this.$box.html(), !1),
    ...
    b.prototype.setHTML = function(b, c) {
        ...
        c === !0 && (this.restoreSelectionByMarkers(),
        this.sync()),
    ...
    b.prototype.breakHTML = function(b) {
        ...
        this.$element.hasClass("f-placeholder"))
            return this.$element.html(b),
            !0;
        var c = this.getSelectionElements()[0];
        if (c == this.$element.get(0))
            return this.insertHTML(b),
            !0;
        if (this.emptyElement(a(c)))
            return a(c).replaceWith(b),
            !0;
        this.insertHTML("<break></break>");
    ...
    b.prototype.processPaste = function() {
        ...
        null === this.clipboardHTML && (b = this.$pasteDiv.html(),
        this.restoreSelectionByMarkers(),
        a(window).scrollTop(this.scrollPosition));
        var c, d = this.triggerEvent("onPaste", [b], !1);
        if ("string" == typeof d && (b = d),
        b = b.replace(/<img /gi, '<img data-fr-image-pasted="true" '),
        b.match(/(class=\"?Mso|style=\"[^\"]*\bmso\-|w:WordDocument)/gi) ? c = this.wordClean(b) : (c = this.clean(b, !1, !0),
        c = this.removeEmptyTags(c)),
        this.options.plainPaste && (c = this.plainPasteClean(c)),
        "" !== c) {
        ...
        this.$element.get(0).onpaste = a.proxy(function(b) {
            if (!this.isHTML) {
                ...
                if (b && b.clipboardData && b.clipboardData.getData) {
                    ...
                    "" !== this.clipboardHTML ? c = !0 : this.clipboardHTML = null,
                    c)
    ...
    b.prototype.uploadPastedImages = function() {
        this.$element.find("img[data-fr-image-pasted]").each(a.proxy(function(b, c) {
            ...
            }, this))) : 0 !== c.src.indexOf("http") && a(c).remove(),
            a(c).removeAttr("data-fr-image-pasted")) : a(c).remove()
        }, this))
    }
    ,
    ...
    b.prototype.wordClean = function(a) {
        ...
        do
            e = a,
            a = a.replace(/<[^\/>][^>]*><\/[^>]+>/gi, "");
        while (a != e);return a = this.clean(a)
    }
    ,
        ...
        for (d = 0; d < a.length; d++)
            ...
            "<" == c) {
                ...
                if (-1 !== k) {
                    ...
                    if ("pre" === m && (j = n ? !1 : !0),
                    this.isSelfClosingTag(l))
                        i.push("br" === m && j ? "\n" : l);
                    else if (n)
                        for (e = !1,
                        f = !0; e === !1 && void 0 !== f; )
                            f = h.pop(),
                            void 0 !== f && f.tag_name !== m ? i.splice(f.i, 1) : (e = !0,
                            void 0 !== f && i.push(l));
                    else
                        i.push(l),
                        h.push({
    ...
    b.prototype.clean = function(b, c, d, e, f) {
        ...
        c || (f.indexOf("id") > -1 && f.splice(f.indexOf("id"), 1),
        f.indexOf("class") > -1 && f.splice(f.indexOf("class"), 1)),
    ...
    b.prototype.enableTyping = function() {
        ...
        this.$element.on("keydown cut", a.proxy(function(b) {
            ...
            void (this.typingTimer = setTimeout(a.proxy(function() {
                var a = this.getHTML();
                this.ime || a.replace(/[\u3041-\u3096]|[\u30A0-\u30FF]|[\u4E00-\u9FFF]/gi, "") == this.oldHTML.replace(/[\u3041-\u3096]|[\u30A0-\u30FF]|[\u4E00-\u9FFF]/gi, "") || (this.saveUndoStep(),
                this.sync())
    ...
    b.prototype.getHTML = function(b, c) {
        ...
        this.$element.find("pre").each(a.proxy(function(b, c) {
            var d = a(c)
              , e = d.html()
              , f = e.replace(/\&nbsp;/gi, " ");
            e != f && (this.saveSelectionByMarkers(),
            d.html(f),
            this.restoreSelectionByMarkers())
        }, this));
    ...
    b.prototype.initAjaxSaver = function() {
        ...
        this.ajaxInterval = setInterval(a.proxy(function() {
            var a = this.getHTML();
            this.ajaxHTML != a && this.ajaxSave && (this.options.autosave && this.save(),
            this.ajaxHTML = a),
            this.ajaxSave = !0
    ...
    b.prototype.saveUndoStep = function() {
        ...
        return this.undoStack[this.undoIndex - 1] && this.removeMarkersByRegex(this.undoStack[this.undoIndex - 1]) == a ? !1 : (this.selectionInEditor() && this.$element.is(":focus") && this.saveSelectionByMarkers(),
        this.undoStack.push(this.getHTML(!0)),
        this.undoIndex++,
        this.selectionInEditor() && this.$element.is(":focus") && this.restoreSelectionByMarkers(!1),
        this.refreshUndo(),
    ...
    b.prototype.initShortcuts = function() {
        this.options.shortcuts && this.$element.on("keydown", a.proxy(function(a) {
            var b = a.which
              , c = (a.ctrlKey || a.metaKey) && !a.altKey;
            if (!this.isHTML && c) {
                if (this.shortcuts_map[b] && this.shortcutEnabled(this.shortcuts_map[b]))
                    return this.execDefaultShortcut.apply(this, this.shortcuts_map[b].split(" "));
                if (90 == b && a.shiftKey)
                    return a.preventDefault(),
                    a.stopPropagation(),
                    this.redo(),
    ...
    b.prototype.focus = function(c) {
        ...
        if (!this.isHTML) {
            ...
            if ("" === this.text() && d && (0 === d.startOffset || d.startContainer === this.$element.get(0) || !this.inEditor(d.startContainer))) {
                ...
                if (a.merge(["IMG", "BR"], a.Editable.VALID_NODES).indexOf(this.getSelectionElement().tagName) < 0)
                    return !1;
                if (g.length >= 1 && g[0] !== this.$element.get(0))
                    for (e = 0; e < g.length; e++)
                        if (f = g[e],
                        !this.textEmpty(f) || this.browser.msie)
                            return void this.setSelection(f);
                if (d.startContainer === this.$element.get(0) && d.startOffset > 0 && !this.options.paragraphy)
                    return void this.setSelection(this.$element.get(0), d.startOffset);
                for (g = this.$element.find(b.VALID_NODES.join(",")),
                e = 0; e < g.length; e++)
                    if (f = g[e],
                    !this.textEmpty(f) && 0 === a(f).find(a.Editable.VALID_NODES.join(",")).length)
                        return void this.setSelection(f);
    ...
    b.prototype.insertHTML = function(a, b) {
        ...
        window.getSelection) {
            ...
            selectPastedContent && (d = c.createRange(),
            d.setEndPoint("StartToStart", i),
            d.select())
        }
        this.no_verify = !1
    }
    ...
    b.prototype.execDefaultShortcut = function(a, b) {
        return this.isEnabled(a) ? (this.exec(a, b),
        !1) : !0
    }
    ,
    ...
    b.prototype.toolbarTop = function() {
        a(window).on("scroll resize", a.proxy(function() {
            this.options.toolbarFixed || this.options.inlineMode || (a(window).scrollTop() > this.$box.offset().top && a(window).scrollTop() < this.$box.offset().top + this.$box.height() ? (this.$editor.addClass("f-scroll"),
            this.$box.css("padding-top", this.$editor.height()),
            this.$editor.css("top", a(window).scrollTop() - this.$box.offset().top)) : a(window).scrollTop() < this.$box.offset().top && (this.$editor.removeClass("f-scroll"),
        ...
        this.$element.on("mouseup touchend", a.proxy(function(b) {
            ...
            if (!this.isResizing()) {
                ...
                !("" !== c || this.options.alwaysVisible || this.options.editInPopup || (3 == b.which || 2 == b.button) && this.options.inlineMode && !this.isImage && this.options.disableRightClick) || this.link || this.imageMode ? this.options.inlineMode || this.refreshButtons() : setTimeout(a.proxy(function() {
                    c = this.text(),
                    !("" !== c || this.options.alwaysVisible || this.options.editInPopup || (3 == b.which || 2 == b.button) && this.options.inlineMode && !this.isImage && this.options.disableRightClick) || this.link || this.imageMode || (this.show(b),
    ...
    b.prototype.blur = function(b) {
        ...
        b && 0 === a("*:focus").length && this.clearSelection(),
        this.selectionDisabled = !1,
        this.blurred = !0)
    }
    ,
        ...
        this.$document.on("selectionchange." + this._id, a.proxy(function(b) {
            ...
            this.selectionChangedTimeout = setTimeout(a.proxy(function() {
                if (this.options.inlineMode && this.selectionInEditor() && this.link !== !0 && this.isTouch()) {
                    var a = this.text();
                    "" !== a ? (this.iPhone() || this.iPod() ? this.options.alwaysVisible || this.hide() : this.show(null),
                    b.stopPropagation()) : this.options.alwaysVisible || (this.hide(),
                    this.closeImageMode(),
                    this.imageMode = !1)
                }
            }, this), 75)))
    ...
    b.prototype.setWindowMouseUpEvent = function() {
        this.$window.on("mouseup." + this._id, a.proxy(function() {
            ...
            this.imageMode = !1),
            this.blur(!0)),
            void a("[data-down]").removeAttr("data-down"))
        }, this))
    }
    ,
    ...
    b.prototype.checkPlaceholder = function() {
        ...
        if (this.pasting)
            return !1;
        if (this.browser.msie || this.$element.find(a.Editable.VALID_NODES.join(":empty, ")).remove(),
        !this.isHTML)
            if (this.isEmpty() && !this.fakeEmpty()) {
                var c, d = this.selectionInEditor() || this.$element.is(":focus");
                this.options.paragraphy ? (c = a("<p><br/></p>"),
                this.$element.html(c),
                d && this.setSelection(c.get(0)),
                ...
                !this.$element.find("p").length && this.options.paragraphy ? (this.wrapText(!0),
    ...
    b.prototype.setDirection = function(a) {
        ...
        "rtl" == this.options.direction ? (this.$element.addClass("f-rtl"),
        this.$editor.addClass("f-rtl"),
        this.$popup_editor.addClass("f-rtl"),
        this.$image_modal && this.$image_modal.addClass("f-rtl")) : (this.$element.removeClass("f-rtl"),
    ...
    b.prototype.setLanguage = function(b) {
        ...
        a.Editable.LANGS[this.options.language] && (this.customizeText(a.Editable.LANGS[this.options.language].translation),
        ...
        for (var c, d, e = "", f = 0; f < this.options.buttons.length; f++) {
            ...
            if ("sep" != g) {
                ...
                if (void 0 !== h) {
                    ...
                    i ? e += i.apply(this, [h]) : h.seed ? (c = this.buildDefaultDropdown(h),
                    d = this.buildDropdownButton(h, c),
                    e += d) : (d = this.buildDefaultButton(h),
                    e += d,
                    this.bindRefreshListener(h))
                } else {
                    if (h = this.options.customButtons[g],
                    void 0 === h) {
                        if (h = this.options.customDropdowns[g],
                        void 0 === h)
                            continue;
    ...
    b.prototype.bindButtonEvents = function() {
        this.isTouch() ? (this.mousedown = "touchstart",
        this.mouseup = "touchend",
        this.move = "touchmove") : (this.mousedown = "click mousedown",
    ...
    b.prototype.bindDropdownEvents = function() {
        ...
        this.$bttn_wrapper.on(this.mouseup, ".fr-dropdown .fr-trigger:not([disabled])", function(d) {
            ...
            !a(this).attr("data-down"))
                return a("[data-down]").removeAttr("data-down"),
                !1;
            a("[data-down]").removeAttr("data-down"),
            "touchend" === d.type && c.android() && (c.saveSelectionByMarkers(),
            setTimeout(function() {
    ...
    b.prototype.bindCommandEvents = function() {
        ...
        this.$bttn_wrapper.on(this.mousedown, "button[data-cmd], li[data-cmd], span[data-cmd], a[data-cmd]", function(c) {
            return "mousedown" === c.type && 1 !== c.which ? !0 : ("LI" === this.tagName && "touchstart" === c.type && b.android() || b.iOS() || c.preventDefault(),
        ...
        this.$bttn_wrapper.on(this.mouseup + " " + this.move, "button[data-cmd], li[data-cmd], span[data-cmd], a[data-cmd]", a.proxy(function(c) {
            ...
            if ("touchmove" != c.type) {
                ...
                !a(d).attr("data-down"))
                    return a("[data-down]").removeAttr("data-down"),
                    !1;
                if (a("[data-down]").removeAttr("data-down"),
                a(d).data("dragging"))
                    return a(d).removeData("dragging"),
                    !1;
                var e = a(d).data("cmd")
                  , f = a(d).data("val")
                  , g = a(d).data("param");
                return "touchend" == c.type && b.android() && (this.saveSelectionByMarkers(),
                this.restoreSelectionByMarkers()),
                b.exec(e, f, g),
    ...
    b.prototype.sanitizeURL = function(a) {
        if (/^https?:\/\//.test(a)) {
            ...
            a = encodeURIComponent(a).replace(/%23/g, "#").replace(/%2F/g, "/").replace(/%25/g, "%").replace(/mailto%3A/g, "mailto:").replace(/data%3A/g, "data:").replace(/webkit-fake-url%3A/g, "webkit-fake-url:").replace(/%3F/g, "?").replace(/%3D/g, "=").replace(/%26/g, "&").replace(/%2C/g, ",").replace(/%3B/g, ";").replace(/%2B/g, "+").replace(/%40/g, "@");
        return a
    }
    ,
...
function(a) {
    a.Editable.prototype.refreshButtons = function(b) {
        if (!(this.selectionInEditor() && !this.isHTML || this.browser.msie && a.Editable.getIEversion() < 9 || b))
            return !1;
...
function(a) {
    ...
    a.Editable.prototype.exec = function(b, c, d) {
        ...
        !1) : (a.Editable.commands[b].callback ? a.Editable.commands[b].callback.apply(this, [b, c, d]) : this.execDefault(b, c),
        void (a.Editable.commands[b].undo && this.saveUndoStep()))
    }
    ,
    a.Editable.prototype.html = function() {
        var a;
        this.isHTML ? (this.isHTML = !1,
        a = this.$html_area.val(),
        a = this.clean(a, !0, !1),
        ...
        this.saveUndoStep(),
        this.options.paragraphy && this.wrapText(),
        this.$element.blur(),
        this.focus(),
        this.refreshButtons(),
        this.triggerEvent("htmlHide", [a], !0, !0)) : (this.$element.removeClass("f-placeholder"),
        this.cleanify(!1),
        a = this.options.inlineMode ? "\n\n" + this.cleanTags(this.getHTML(!1, !1)) : this.cleanTags(this.getHTML(!1, !1)),
        a = a.replace(/\&amp;/g, "&"),
        this.$html_area.val(a).trigger("resize"),
    ...
    a.Editable.prototype.formatBlock = function(b, c, d) {
        ...
        if (this.browser.msie && a.Editable.getIEversion() < 9)
            return document.execCommand("formatBlock", !1, "<" + b + ">"),
            !1;
        this.saveSelectionByMarkers(),
        this.wrapText(),
        this.restoreSelectionByMarkers();
        ...
        for (var f, g = function(a) {
            ...
            var i = a(e[h]);
            if (!this.fakeEmpty(i))
                if (f = "n" == b ? this.options.paragraphy ? a("<p>").html(i.html()) : i.html() + "<br/>" : a("<" + b + ">").html(i.html()),
                i.get(0) == this.$element.get(0) || g(f))
                    i.html(f);
                else {
    ...
    a.Editable.prototype.align = function(b) {
        if (this.browser.msie && a.Editable.getIEversion() < 9)
            return document.execCommand(b, !1, !1),
            !1;
        this.saveSelectionByMarkers();
    ...
    a.Editable.prototype.indent = function(b) {
        if (this.browser.msie && a.Editable.getIEversion() < 9)
            return b ? document.execCommand("outdent", !1, !1) : document.execCommand("indent", !1, !1),
            !1;
        var c = 20;
        b && (c = -20),
        this.saveSelectionByMarkers(),
        ...
        for (var e = 0; e < d.length; e++) {
            var f = a(d[e]);
            if (f.parentsUntil(this.$element, "li").length > 0 && (f = f.closest("li")),
            "LI" === f.get(0).tagName && a.isFunction(this.indentLi))
    ...
    a.Editable.prototype.inlineStyle = function(b, c, d) {
        if (this.browser.webkit && "font-size" != b) {
            ...
            this.$element.find("span").each(function(b, c) {
                var d = a(c);
                d.attr("style") && e(d) && (d.data("font-size", d.css("font-size")),
                d.css("font-size", ""))
            })
        }
        ...
        this.browser.webkit && "font-size" != b && this.$element.find("span").each(function(b, c) {
            var d = a(c);
            d.data("font-size") && (d.css("font-size", d.data("font-size")),
            d.removeData("font-size"))
        });
        var f = function(c, e) {
            var f = a(e);
            f.css(b) != d && f.css(b, ""),
...
function(a) {
    ...
    a.Editable.prototype.getSelectionParent = function() {
        var b, c = null;
        return window.getSelection ? (b = window.getSelection(),
        b.rangeCount && (c = b.getRangeAt(0).commonAncestorContainer,
    ...
    a.Editable.prototype.getElementFromNode = function(b) {
        for (1 != b.nodeType && (b = b.parentNode); null !== b && a.Editable.VALID_NODES.indexOf(b.tagName) < 0; )
            b = b.parentNode;
    ...
    a.Editable.prototype.restoreSelection = function() {
        if (!this.selectionDisabled) {
            ...
            if (this.savedRanges && this.savedRanges.length)
                for (c.removeAllRanges(),
                a = 0,
                b = this.savedRanges.length; b > a; a += 1)
    ...
    a.Editable.prototype.insertMarkersAtPoint = function(a) {
        ...
        e.setEnd(d.offsetNode, d.offset)) : "undefined" != typeof document.caretRangeFromPoint && (d = document.caretRangeFromPoint(b, c),
        e = document.createRange(),
    ...
    a.Editable.prototype.restoreSelectionByMarkers = function(b) {
        ...
        !this.selectionDisabled) {
            ...
            for (var e = 0; e < c.length; e++) {
                ...
                if (f = b ? document.createRange() : this.getRange(),
                i.length > 0) {
                    i = i[0];
                    try {
                        f.setStartBefore(h),
    ...
    a.Editable.prototype.getSelectionTextInfo = function(a) {
        ...
        if (window.getSelection) {
            ...
            document.selection && "Control" != document.selection.type && (b = document.selection.createRange(),
            c = b.duplicate(),
...
function(a) {
    ...
    a.Editable.prototype.hide = function(a) {
        return this.initialized ? (void 0 === a && (a = !0),
        a ? this.hideOtherEditors() : (this.closeImageMode(),
        this.imageMode = !1),
...
function(a) {
    ...
    a.Editable.prototype.repositionEditor = function(b) {
        ...
        if (this.options.inlineMode || b) {
            if (c = this.getBoundingRect(),
            this.showBttnWrapper(),
            c.ok || c.left >= 0 && c.top >= 0 && c.right > 0 && c.bottom > 0)
                d = c.left + c.width / 2,
                e = c.top + c.height,
    ...
    a.Editable.prototype.showByCoordinates = function(b, c) {
        ...
        this.$popup_editor.css("top", c),
        this.$popup_editor.css("left", Math.max(a(window).width() - d, 10) / 2),
...
function(a) {
    ...
    a.Editable.prototype.insertImageHTML = function() {
        ...
        this.options.imageUpload && (b += '<div class="f-popup-line drop-upload">',
        b += '<div class="f-upload" id="f-upload-div-' + this._id + '"><strong data-text="true">Drop Image</strong><br>(<span data-text="true">or click</span>)<form target="frame-' + this._id + '" enctype="multipart/form-data" encoding="multipart/form-data" action="' + this.options.imageUploadURL + '" method="post" id="f-upload-form-' + this._id + '"><input id="f-file-upload-' + this._id + '" type="file" name="' + this.options.imageUploadParam + '" accept="image/*"></form></div>',
        this.browser.msie && a.Editable.getIEversion() <= 9 && (b += '<iframe id="frame-' + this._id + '" name="frame-' + this._id + '" src="javascript:false;" style="width:0; height:0; border:0px solid #FFF; position: fixed; z-index: -1;"></iframe>'),
        b += "</div>"),
    ...
    a.Editable.prototype.initImageEvents = function() {
        ...
        this.$element.on("mousedown", 'img:not([contenteditable="false"])', function(c) {
            ...
            b.$element.attr("contenteditable", !1),
            a(this).addClass("fr-image-move")))
        }),
        ...
        this.$element.on("click touchend", 'img:not([contenteditable="false"])', function(c) {
            ...
            if (!b.isResizing()) {
                ...
                b.options.imageResize && (a(this).parent().append(f.clone(!0).addClass("f-h-ne")),
                a(this).parent().append(f.clone(!0).addClass("f-h-se")),
                a(this).parent().append(f.clone(!0).addClass("f-h-sw")),
                a(this).parent().append(f.clone(!0).addClass("f-h-nw"))),
    ...
    a.Editable.prototype.linkImage = function(a) {
        this.showInsertLink(),
        this.imageMode = !0,
        "A" == a.parent().get(0).tagName ? (this.$link_wrapper.find('input[type="text"]').val(a.parent().attr("href")),
    ...
    a.Editable.prototype.buildDragUpload = function() {
        ...
        b.$image_wrapper.on("drop", "#f-upload-div-" + this._id, function(c) {
            ...
            c.stopPropagation(),
            b.options.imageUpload ? (a(this).removeClass("f-hover"),
        ...
        b.$element.on("drop", function(c) {
            ...
            b.hide(),
            b.imageMode = !1,
            !b.options.imageUpload || 0 !== b.$element.find(".fr-image-move").length) {
                if (b.$element.find(".fr-image-move").length > 0 && b.options.imageMove) {
                    ...
                    b.$element.find(".fr-image-move").removeClass("fr-image-move");
                return c.preventDefault(),
                c.stopPropagation(),
                !1
            }
    ...
    a.Editable.prototype.processInsertImage = function(b, c) {
        ...
        g && g.hasClass("f-img-wrap") ? (1 === f.startOffset ? (g.after('<p><span class="f-marker" data-type="true" data-id="0"></span><br/><span class="f-marker" data-type="false" data-id="0"></span></p>'),
        this.restoreSelectionByMarkers(),
        this.getSelection().collapseToStart()) : 0 === f.startOffset && (g.before('<p><span class="f-marker" data-type="true" data-id="0"></span><br/><span class="f-marker" data-type="false" data-id="0"></span></p>'),
        this.restoreSelectionByMarkers(),
        this.getSelection().collapseToStart()),
        this.insertHTML(d)) : this.getSelectionTextInfo(e).atStart && e != this.$element.get(0) && "TD" != e.tagName && "TH" != e.tagName && "LI" != e.tagName ? a(e).before("<p>" + d + "</p>") : this.insertHTML(d),
        this.disable()
    }
    ,
    ...
    a.Editable.prototype.uploadImage = function(b) {
        ...
        if (void 0 !== b && b.length > 0) {
            ...
            c) {
                ...
                if (c.append(this.options.imageUploadParam, b[0]),
                b[0].size > this.options.maxImageSize)
    ...
    a.Editable.prototype.parseImageResponse = function(b) {
        try {
            var c = a.parseJSON(b);
            c.info ? this.writeImage(c.info) : c.msg ? this.throwImageErrorWithMessage(c.msg) : this.throwImageError(2)
        } catch (d) {
            this.throwImageError(4)
        }
    }
    ...
    a.Editable.prototype.refreshImageList = function(b) {
        if (!this.isLink && !this.options.editInPopup) {
            ...
            if (this.$element.find("img").each(function(b, f) {
                var g = a(f);
                if (c.push(g.attr("src")),
                d.push(g),
                0 === g.parents(".f-img-editor").length && !g.hasClass("fr-fil") && !g.hasClass("fr-fir") && !g.hasClass("fr-fin")) {
                    var h;
                    "right" == g.css("float") ? (h = g.parent(),
                    h.hasClass("f-img-editor") ? h.addClass("fr-fir") : g.addClass("fr-fir")) : "left" == g.css("float") ? (h = g.parent(),
...
function(a) {
    ...
    a.Editable.prototype.initLinkEvents = function() {
        var b = this
          ...
          , d = function(c) {
            ...
            b.clearSelection(),
            b.removeMarkers(),
            b.selectionDisabled || (a(this).before('<span class="f-marker" data-type="true" data-id="0" data-fr-verified="true"></span>'),
            ...
            b.isLink ? ("#" == d && (d = ""),
            b.$link_wrapper.find("input#f-lu-" + b._id).val(d.replace(/\&amp;/g, "&")),
            b.$link_wrapper.find(".f-external-link").attr("href", d || "#")) : (b.$link_wrapper.find("input.f-lu").val(d.replace(/\&amp;/g, "&")),
            b.$link_wrapper.find(".f-external-link").attr("href", d)),
        ...
        this.isLink ? this.iOS() ? (this.$element.on("click", c),
        this.$element.on("touchend", d)) : this.$element.on("click", d) : this.iOS() ? (this.$element.on("click", 'a:not([contenteditable="false"])', c),
        this.$element.on("touchend", 'a:not([contenteditable="false"])', d),
    ...
    a.Editable.prototype.writeLink = function(b, c, d, e, f) {
        ...
        this.imageMode) {
            ...
            this.$element.find('span[data-fr-link="true"]').each(function(b, c) {
                a(c).replaceWith(a(c).html())
            }),
            this.restoreSelectionByMarkers()),
            this.isLink ? (this.$element.text(c),
            g = [this.$element.attr("href", b).get(0)]) : (this.removeMarkers(),
    ...
    a.Editable.prototype.createLinkHTML = function() {
        ...
        var b = "";
        if (this.options.linkList.length && (b = "f-bi"),
        a += '<div class="f-popup-line"><input type="text" placeholder="http://www.example.com" class="f-lu ' + b + '" id="f-lu-' + this._id + '"/>',
        ...
        return a += '<div class="f-popup-line"><input type="checkbox" id="f-checkbox-' + this._id + '"> <label data-text="true" for="f-checkbox-' + this._id + '">Open in new tab</label><button data-text="true" type="button" class="f-ok" id="f-ok-' + this._id + '">OK</button>',
    ...
    a.Editable.prototype.getSelectionLinks = function() {
        ...
        if (window.getSelection) {
            ...
            if (a = document.selection.createRange(),
            b = a.parentElement(),
    ...
    a.Editable.prototype.insertLink = function() {
        ...
        this.$link_wrapper.find('input[type="text"].f-lt').val(a(c[0]).text() || ""),
        a(c[0]).hasClass("fr-file") ? this.$link_wrapper.find('input[type="text"].f-lu').attr("disabled", "disabled") : this.$link_wrapper.find('input[type="text"].f-lu').removeAttr("disabled"),
...
function(a) {
        ...
        this.isImage || this.isLink || this.options.editInPopup || this.$element.on("keydown", a.proxy(function(b) {
            ...
            if (13 == c && "" === this.text() && d.indexOf(e.tagName) >= 0 && 0 === a(e).parents("ul, ol").length)
                if (this.getSelectionTextInfo(e).atEnd && !b.shiftKey) {
                    ...
                    (this.browser.webkit || this.browser.msie) && (b.preventDefault(),
                    this.insertHTML(this.endsWith(a(e).html(), "<br>") || !this.getSelectionTextInfo(e).atEnd ? "<br>" : "<br><br>"))
        }, this))
    }
    ,
    a.Editable.prototype.domInsert = function() {
        this.$element.on("DOMNodeInserted", a.proxy(function(b) {
            "SPAN" != b.target.tagName || a(b.target).attr("data-fr-verified") || this.no_verify || (a(b.target).before(a(b.target).contents()),
            a(b.target).remove())
        }, this))
    }
    ,
    a.Editable.prototype.fixIME = function() {
        ...
        this.$element.get(0).msGetInputContext().addEventListener("MSCandidateWindowHide", a.proxy(function() {
            this.ime = !1,
...
function(a) {
    ...
    "function" == typeof Array.prototype.indexOf && !function(a) {
...
window.WYSIWYGModernizr = function(a, b, c) {
    ...
    " -webkit- -moz- -o- -ms- ".split(" ")), p = {}, q = [], r = q.slice, s = function(a, c, d, e) {
        ...
        k.appendChild(n)),
        g = c(j, a),
        m ? j.parentNode.removeChild(j) : (n.parentNode.removeChild(n),
        k.style.overflow = i),
        !!g
    }, t = function(b) {
...
!function(a) {
    ...
    a.Editable.prototype.mapDOM = function(b, c) {
                ...
                if (-1 !== p) {
                    ...
                    if (r = e.match(/([\w\-]*)=("[^<>"]*"|'[^<>']*'|\w+)/gi))
                        for (var x = 0; x < r.length; x++)
                            0 === r[x].indexOf("style=") && r.splice(x, 1);
                    if (q) {
                        var y = m[g].pop();
                        h == j[y].start && a.Editable.END_AT_SAME_INDEX.indexOf(g) >= 0 && (n[h] || (n[h] = []),
                        n[h].push({
                            i: j[y].i,
                        ...
                        a.Editable.SEPARATE.indexOf(g) >= 0 && (r ? r.push('data-fr-idx="' + o + '"') : r = ['data-fr-idx="' + o + '"']),
                        j.push({
                            type: g,
                            attrs: r,
                            style: t,
        ...
        for (o = 0; o < l.length; o++) {
            B[o] = {};
            for (var C in l[o])
                B[o][this.extendedKey(l[o][C])] = l[o][C]
        }
        return {
            text: k,
            format: B,
    ...
    a.Editable.prototype.cleanOutput = function(b, c) {
        ...
        e = 0; e <= k.length; e++) {
            var n = []
              , o = "";
            if (j[e])
                for (j[e] = j[e].sort(this.sortSimpleTags),
                g = 0; g < j[e].length; g++)
                    a.Editable.SELF_CLOSING_AFTER.indexOf(j[e][g].tag_name) >= 0 ? o += j[e][g].content : b += j[e][g].content;
            if (m[e]) {
                for (var p in m)
                    if (p > e)
                        for (f = 0; f < m[p].length; f++) {
                            var q = m[p][f];
                            q.start >= m[e][m[e].length - 1].start && a.Editable.TAG_ORDER.indexOf(q.type) > a.Editable.TAG_ORDER.indexOf(m[e][m[e].length - 1].type) && a.Editable.SEPARATE.indexOf(q.type) < 0 && (b += "</" + q.type + ">",
                            n.push(q),
                            m[p].splice(f, 1))
                        }
            ...
            if (l[e])
                for (l[e] = l[e].sort(this.sortNodes),
                f = 0; f < l[e].length; f++)
                    d = l[e][f],
                    m[d.end] || (m[d.end] = []),
                    m[d.end].push(d),
    ...
    a.Editable.prototype.cleanify = function(b, c) {
        ...
        if (d[0] != this.$element.get(0))
            ...
            0 === this.$element.find(e).length && (f = this.$element.html(),
            g = this.cleanOutput(f, c),
            g !== f && this.$element.html(g));
