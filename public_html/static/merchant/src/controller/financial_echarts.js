...
layui.use(['admin', 'carousel'], function(){
    ...
    admin.req({
        url: layui.setter.baseUrl + 'merchant/StatisticsFinancial/renshu_k'
        ,data: data_s
        ,type: 'get'
    ...
    admin.req({
        url: layui.setter.baseUrl + 'merchant/StatisticsFinancial/bishu_k'
        ,data: data_s
        ,type: 'get'
        ,success: function (res) {
            if (res.code == 1) {
    ...
    admin.req({
        url: layui.setter.baseUrl + 'merchant/StatisticsFinancial/jine_k'
        ,data: data_s
        ,type: 'get'
        ,success: function (res) {
            if (res.code == 1) {
    ...
    admin.req({
        url: layui.setter.baseUrl + 'merchant/StatisticsFinancial/renjun_k'
        ,data: data_s
        ,type: 'get'
        ,success: function (res) {
            if (res.code == 1) {
