...
// function all_data(){
    ...
    var xs_fk_zt_data;
    admin.req({
        url: layui.setter.baseUrl + 'merchant/StatisticStransaction/jiaoyi'
        ,data: { }
        ,type: 'get'
...
// 核心指标
    ...
    admin.req({
        url: layui.setter.baseUrl + 'merchant/StatisticStransaction/jiaoyifukuan_k'
        ,data: data_s
        ,type: 'get'
        ,success: function (res) {
            if (res.code == 1) {
    ...
    var j_cjrs_value;
    admin.req({
        url: layui.setter.baseUrl + 'merchant/StatisticStransaction/jiaoyichengjiao'
        ,data: {}
        ,type: 'get'
        ,success: function (res) {
            if (res.code == 1) {
...
element.on('tab(component-tabs-brief)', function(data){    
    ...
    admin.req({
        url: layui.setter.baseUrl + 'merchant/StatisticStransaction/shagnpdognxiao_k'
        ,data: data_s
        ,type: 'get'
        ,success: function (res) {
            if (res.code == 1) {
    ...
    admin.req({
        url: layui.setter.baseUrl + 'merchant/StatisticStransaction/dingdanbishu_k'
        ,data: data_s
        ,type: 'get'
        ,success: function (res) {
            if (res.code == 1) {
    ...
    admin.req({
        url: layui.setter.baseUrl + 'merchant/StatisticStransaction/dingdanjine_k'
        ,data: data_s
        ,type: 'get'
        ,success: function (res) {
            if (res.code == 1) {
    ...
    admin.req({
        url: layui.setter.baseUrl + 'merchant/StatisticStransaction/tuihuo_k'
        ,data: data_s
        ,type: 'get'
        ,success: function (res) {
            if (res.code == 1) {
    ...
    admin.req({
        url: layui.setter.baseUrl + 'merchant/StatisticStransaction/zhonglei_k'
        ,data: data_s
        ,type: 'get'
        ,success: function (res) {
            if (res.code == 1) {
    ...
    admin.req({
        url: layui.setter.baseUrl + 'merchant/StatisticStransaction/xianshang_k'
        ,data: data_s
        ,type: 'get'
        ,success: function (res) {
            if (res.code == 1) {
    ...
    admin.req({
        url: layui.setter.baseUrl + 'merchant/StatisticStransaction/xianxia_k'
        ,data: data_s
        ,type: 'get'
        ,success: function (res) {
            if (res.code == 1) {
